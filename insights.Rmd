...
FavoriteSong <- tibble(pseudonym=survey$pseudonym, favorite_song=survey$favortie_song, favorite_song_link=survey$favorite_song_link)
...
```{r}
colnames(Ratings)[colnames(Ratings) == "What is your pseudonym?"] <- "pseudonym"
